...
function renderResearch(){
 ...
 const reportHtml=p=>{
  const x=p?.last_analysis||{},dev=x.development_summary||{},val=x.validation_summary||{},good=x.good||[],bad=x.bad||[],next=x.next_steps||[],ov=x.selected_overrides||{},perf=x.performance||{},sp=x.data_splits||{},prov=x.provenance||{};
  if(!x.profile)return"";
